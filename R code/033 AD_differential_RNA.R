...
####within Female
options(na.action='na.pass')
Maindm <- model.matrix(~0 + Cog_Path_F + age + pmi_F + X10X_batch_F)
...
options(na.action='na.pass')
Maindm <- model.matrix(~0 + Cog_Path_M + age + pmi_M + X10X_batch_M)
...
options(na.action='na.pass')
Maindm <- model.matrix(~0 + ad_adnc + msex + age + pmi + X10X_batch)
...
options(na.action='na.pass')
Maindm <- model.matrix(~0 + gpath + msex + age + pmi + X10X_batch)
rownames(Maindm) <- rownames(mdat)
colnames(Maindm)
Maindm <- Maindm[complete.cases(Maindm),]
...
options(na.action='na.pass')
Maindm <- model.matrix(~0 + Braaksc + msex + age + pmi + X10X_batch)
rownames(Maindm) <- rownames(mdat)
colnames(Maindm)
Maindm <- Maindm[complete.cases(Maindm),]
...
options(na.action='na.pass')
Maindm <- model.matrix(~0 + tdp + msex + age + pmi + X10X_batch)
rownames(Maindm) <- rownames(mdat)
colnames(Maindm)
Maindm <- Maindm[complete.cases(Maindm),]
...
options(na.action='na.pass')
Maindm <- model.matrix(~0 + tangles + msex + age + pmi + X10X_batch)
rownames(Maindm) <- rownames(mdat)
colnames(Maindm)
Maindm <- Maindm[complete.cases(Maindm),]
...
options(na.action='na.pass')
Maindm <- model.matrix(~0 + amyl + msex + age + pmi + X10X_batch)
rownames(Maindm) <- rownames(mdat)
colnames(Maindm)
Maindm <- Maindm[complete.cases(Maindm),]
...
options(na.action='na.pass')
Maindm <- model.matrix(~0 + arteriol + msex + age + pmi + X10X_batch)
rownames(Maindm) <- rownames(mdat)
colnames(Maindm)
Maindm <- Maindm[complete.cases(Maindm),]
...
options(na.action='na.pass')
Maindm <- model.matrix(~0 + caa + msex + age + pmi + X10X_batch)
rownames(Maindm) <- rownames(mdat)
colnames(Maindm)
Maindm <- Maindm[complete.cases(Maindm),]
...
options(na.action='na.pass')
Maindm <- model.matrix(~0 + cvda + msex + age + pmi + X10X_batch)
rownames(Maindm) <- rownames(mdat)
colnames(Maindm)
Maindm <- Maindm[complete.cases(Maindm),]
...
options(na.action='na.pass')
Maindm <- model.matrix(~0 + cogn_global + msex + age + pmi + X10X_batch)
rownames(Maindm) <- rownames(mdat)
colnames(Maindm)
Maindm <- Maindm[complete.cases(Maindm),]
...
####AD cogdx
options(na.action='na.pass')
Maindm <- model.matrix(~0 + cogdx + msex + age + pmi + pmi + X10X_batch)
